...
# 模擬滾動加載更多內容
SCROLL_PAUSE_TIME = 5  # 滾動後等待加載的時間
scroll_amount = 20000  # 每次向下滾動的距離
...
# 找到所有的新聞鏈接
for each_item in soup.find_all("h3", class_="Mb(5px)"):
    a_tag = each_item.find("a")
    if a_tag:
        yahoo_url = 'https://tw.news.yahoo.com' + a_tag.get('href')
